                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="py-2">
                            ...
                            for ($i = 1; $i <= 5; $i++) {
                                echo ($i <= $puan) ? '<i class="fa fa-star text-warning"></i>' : '<i class="fa fa-star text-secondary"></i>';
                            }
                            ?>
                            <span class="list-inline-item text-dark">Rating <?php echo $puan; ?></span>
                        </p>
